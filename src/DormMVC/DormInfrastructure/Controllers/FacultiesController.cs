...
namespace DormInfrastructure.Controllers
{
    public class FacultiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FacultyId,FacultyName,Dean,CreatedAt,UpdatedAt")] Faculty faculty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(byte id, [Bind("FacultyId,FacultyName,Dean,CreatedAt,UpdatedAt")] Faculty faculty)
        {
