...
namespace DormInfrastructure.Controllers
{
    ...
    public class PaymentTypesController : Controller
    {
        ...
        public PaymentTypesController(DormContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PaymentTypeId,PaymentName")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(byte id, [Bind("PaymentTypeId,PaymentName")] PaymentType paymentType)
        {
        ...
        private bool PaymentTypeExists(byte id)
        {
